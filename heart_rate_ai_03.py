...
while True:
    ...
    faces = face_cascade.detectMultiScale(
        gray_image, scaleFactor=1.5, minNeighbors=3, minSize=(300, 300), flags=cv2.CASCADE_SCALE_IMAGE
    )
    ...
    for face_coordinates in faces:
        ...
        # Calculate the average gree color value in the facial region
        average_green_value = cv2.mean(facial_region, mask=None)[1]

        # Append the average red value to the heart rate history
        heart_rates.append(average_green_value)
